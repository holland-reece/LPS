```
# Behavioral analysis for LPS Study

# Based on Liisbeth Pirn's code for LPS study behavioral analysis
...
## Notes:
#### To double-check the data when necessary, timing info (block labels) are also available in /LPS_STHLM/sourcedata/InteroceptionLogFiles/ses-0{1-4}_onsets.csv
